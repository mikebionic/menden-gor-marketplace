...
export const Navbar = (props: any) => {
	...
	const CategoryItem = () => {
		return (
			<div className="relative inline-block w-full grid-flow-row p-2 shadow-lg auto-rows-max h-80 2xl:h-96 mt-[2px] left-12 bg-fullwhite dark:bg-darkComponentColor">
