		...
		<Helmet>
			...
			<meta
				...
				content={
					description
						? description
						: 'Biziň maksadymyz siziň ösüşiňize sebäp bolmak'
				}
			/>
			<meta property="og:url" content={url ? url : 'https://ls.com.tm'} />
			<meta property="og:type" content={type ? type : 'website'} />
			<meta property="article:publisher" content="https://www.ls.com.tm" />
