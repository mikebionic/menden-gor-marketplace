...
const LangButton = ({ onDropdownStateChange, dropdownState, data }: any) => {
	...
	const LanguageItem = ({ icon, data }: any) => {
		return (
			<div
				className={`w-full relative p-2 hover:text-textColorOrange dark:hover:text-darkFirstColor flex cursor-pointer place-items-center hover:bg-gray-100 dark:hover:bg-darkComponentColor text-black dark:text-darkTextWhiteColor`}
				onClick={() => {
					setLanguage(data)
