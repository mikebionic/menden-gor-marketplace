...
export const MobileNavbar: React.FC = () => {
  return (
    <header className="grid gap-4 grid-cols-[max-content_1fr] px-3 place-content-around items-center fixed w-full h-20 shadow-[0px_4px_8px_rgba(0,0,0,0.2)] bg-gradient-to-r from-firstColorGradientFromDark to-secondColorGradientToLight">
