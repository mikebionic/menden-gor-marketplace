...
export const CategoryListItem: React.FC<ICategoryListItem> = ({
	...
	return (
		<div className="relative group">
			<button className="inline-grid items-center w-full cursor-pointer hover:relative hover:shadow-BannerCategory hover:text-socialBarItemHover bg-fullwhite dark:bg-darkComponentColor grid-cols-search h-11 2xl:h-14">
				<Image
					src={icon}
					alt={name}
				...
				<MdOutlineKeyboardArrowRight className="mr-2 dark:text-darkTextWhiteColor hover:text-socialBarItemHover 2xl:w-5 2xl:h-5" />
			</button>
